...
1. On the right side options, select the **+** button next to **Work Items**. Link the previously created work item to the Pull Request by selecting on it. You will see one of the requirements changes status.
