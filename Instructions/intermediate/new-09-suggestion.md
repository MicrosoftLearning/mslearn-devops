...
lab:
  ...
  description: Build and manage internal NuGet packages for a microservices architecture
    using Azure Artifacts, simulating a real-world enterprise scenario.
  duration: 40 minutes
  level: 400
  islab: true
  primarytopics:
